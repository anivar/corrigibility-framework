...
\begin{itemize}
    \item Framework documentation: \url{https://github.com/anivar/corrigibility-schema}
    \item Infrastructure manifest schema: \url{https://github.com/anivar/corrigibility-schema/blob/main/schema/dpi/infrastructure.json}
    \item Corrigibility assessment schema: \url{https://github.com/anivar/corrigibility-schema/blob/main/schema/dpi/audit.json}
...
{
  "$id": "https://github.com/anivar/corrigibility-schema/blob/main/schema/dpi/infrastructure.json",
...
{
  "$id": "https://github.com/anivar/corrigibility-schema/blob/main/schema/dpi/audit.json",
