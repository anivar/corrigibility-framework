...
\begin{itemize}
    ...
    \item \textbf{Assessment Skill}: A unified assessment skill (following the Agentic Skills specification \citep{agentskills2025}) that works with both DPI and EPI schemas. The skill classifies target systems, applies appropriate test criteria, and generates machine-readable assessments. Located at \texttt{skills/corrigibility-assessment/}.
...
The unified skill demonstrates that the five tests remain invariant across DPI and EPI---only the verification method and evidence requirements adapt to the system type.
