...
WCC & Workflow capture threshold & $> 0.7$ triggers FORK fail & \ref{appendix:neutrality} \\
\bottomrule
\end{tabular}
\end{table}
...
Ontology & Incontestability & Epistemic & Open Standards / Contestability \\
