...
\begin{itemize}
    ...
    \item \textbf{Assessment Skill}: A unified assessment skill (following the Agentic Skills specification) that works with both DPI and EPI schemas. The skill decomposes systems into architectural layers (identity, credential, payment, data\_exchange, registry), applies the five tests, and generates machine-readable assessments. Located at \texttt{skills/corrigibility-assessment/}.
