...
\begin{itemize}
    \item Framework documentation: \url{https://anivar.net/corrigibility/dpi/}
    \item Infrastructure manifest schema: \url{https://anivar.net/corrigibility/dpi/schema/infrastructure.json}
    \item Corrigibility assessment schema: \url{https://anivar.net/corrigibility/dpi/schema/corrigibility.json}
