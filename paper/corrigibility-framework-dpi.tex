...
\node[failure, right=2.8cm of participation.east, anchor=west] {If removed: \textbf{Coercive lock-in}\\(no error signal)};
\node[failure, right=2.8cm of observability.east, anchor=west] {If removed: \textbf{Opaque drift}\\(errors undetectable)};
