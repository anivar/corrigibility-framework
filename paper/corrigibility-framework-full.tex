...
This is the lesson of PSD2 in banking: portability mandates reduced $c_{\text{data}}$ and $c_{\text{legal}}$, making bank-switching economically viable (see also Section~\ref{subsubsec:fee}).
...
This reframing matters for policy. The discourse of ``AI risk'' often conflates capability with capture. Corrigibility separates these concerns: a system can be simultaneously powerful and accountable, or weak and authoritarian. The question is not ``How smart is it?'' but ``Can those it affects correct it?'' As established in Section~\ref{subsec:institutional}, corrigibility is necessary but not sufficient---institutional capacity determines whether structural safeguards translate into practical accountability.
