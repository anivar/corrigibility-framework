...
% Standard academic packages for policy/law journals
...
\onehalfspacing % Standard for law/policy journal submissions

% Hyperref setup for a solo author
\usepackage[
    colorlinks=true,
...
\title{\textbf{Corrigibility as a Structural Precondition for Digital Public Infrastructure: A Cybernetic Framework}}

\author{
    \textbf{Anivar A Aravind} \\
    \textit{Independent Researcher} \\
    \href{mailto:ping@anivar.net}{\texttt{ping@anivar.net}} \\
    ORCID: \href{https://orcid.org/0009-0009-8995-0005}{0009-0009-8995-0005}
}
