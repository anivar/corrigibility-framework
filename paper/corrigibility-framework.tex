...
A variant of safety-washing has emerged in DPI discourse: claims that digital infrastructure is inherently ``sustainable'' or ``green'' because it replaces paper, reduces travel, or enables ``efficient'' resource allocation. This \textbf{Climate Washing} deploys environmental rhetoric to deflect accountability critiques.
