...
\centering
\scriptsize
\caption{Three-indicator protocol: continuous score, binary flag, and threshold metric for each test. Thresholds here are the stricter certification tier; Table~\ref{tab:operational-proxies-main} gives screening defaults.}
