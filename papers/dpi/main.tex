...
\begin{itemize}
    ...
    \item \textbf{Protocol Documentation}: \texttt{PROTOCOL.md}, \texttt{AGENTS.md}, \texttt{docs/} --- test and analysis documentation covering EXIT, CODE, AUDIT, GOVERN, FORK, layer decomposition, variety drift, and action boundaries; assessments emit \texttt{audit.json} following Protocol 3.1
