...
\begin{enumerate}
    ...
    \item Discrete integrator supplies an elementary divergence demonstration and absorbs Condition~\ref{cond:friction} through the friction cost $\epsilon$ and the verification bound $V_{\text{verify}}$.
