...
\begin{quote}
``[Identity systems should be] robust, inclusive and accountable\ldots responsive to the needs of various users and enrollment contexts\ldots designed to allow for federation, interoperability, and data portability'' \citep{worldbank2021id4d}.
\end{quote}
