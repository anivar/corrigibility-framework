...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Assessment Skills}: \texttt{skills/assess/} --- Rules and test definitions including LWD-R transparency criteria, Compute Capture detection, Action Boundary verification, and Variety Drift monitoring
...
The schema repository follows the Agentic Skills specification \citep{agentskills2025} and is versioned independently from the theoretical papers to allow schema evolution as DPI/EPI systems mature.
