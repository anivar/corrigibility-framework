...
\date{April 2026 \\ {\small Revised: 10 July 2026 (v3.1)}}
...
Acceleration overwhelm (GDoS) & GOVERN (decisions outpace review) & Action Boundary & Constraint \\
\bottomrule
\end{tabular}
...
\node[font=\tiny, text=red!70!black, anchor=north] at (2.5, -1.2) {If $\Omega$ proprietary: FORK fails};
...
FORK & \textbf{Excellent} ($C_{\text{train}}/C_{\text{accessible}}$ low relative to $\kappa$) & Selection Pressure \\
\bottomrule
\end{tabular}
\end{table}
