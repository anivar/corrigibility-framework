...
\begin{tikzpicture}[scale=0.85,
    ...
    response/.style={rectangle, rounded corners, draw=gray!70, fill=white, minimum width=2.1cm, minimum height=0.55cm, font=\scriptsize, align=center},
...
\node[font=\scriptsize, gray] at (4.6,-2.3) {The five tests are inherited from the companion paper and remain invariant. Verification adapts; the standard does not.};
\end{tikzpicture}
